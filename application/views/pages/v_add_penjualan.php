        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <?php } else {?>
                 <th class="span3">
                        <a href="#modalAddPenjualanBarang" class="btn btn-inverse btn-block" data-toggle="modal">
                        <i class="icon-th icon-plus-sign icon-white"></i> Beli Barang</a>
                </th>
                <?php } ?>
            </tr>
            </thead>
                    ...
                    <div class="controls">
                        ...
                        <?php } else {
                            if(isset($data_pelanggan)){
                                foreach($data_pelanggan as $row){
                                    ?>
                                <input name="kd_pelanggan" type="text" value="<?php echo $row->kd_pelanggan;?>" readonly="readonly" style="display: none">
