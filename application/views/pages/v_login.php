...
<div class="container">
    ...
    <form class="form-signin" action="<?= site_url('login/cek_login')?>" method="post">
        <hr>
        <h4 class="form-signin-heading text-center">Selamat Datang DI UD Gajah Putra</h4>
    ...
    <hr>
    <div class="footer">
        <p>&copy; Created By : <a href="#" target="_blank"><strong>UD Gajah</strong></a></p>
    </div>
</div>
</body>
